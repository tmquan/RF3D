...
class RF3DLightningModule(LightningModule):
    ...
    def forward_volume(self, image2d, dist, elev, azim, n_views=[2, 1], resample_clarity=False, resample_volumes=False): 
        return self.inv_renderer(image2d, dist, elev.squeeze(1), azim.squeeze(1) * 900, n_views, 
